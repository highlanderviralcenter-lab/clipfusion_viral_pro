"""ClipFusion — Prompt Builder. Monta prompt para IA externa e processa resposta."""
import json, re
...
Critérios: gancho forte nos primeiros 3s, valor emocional claro, 20–90s de duração, começo/meio/fim narrativo.
